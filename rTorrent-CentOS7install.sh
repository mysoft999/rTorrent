...
#Install PHP7.2
rpm -Uvh https://github.com/mysoft999/rTorrent/raw/main/webtatic-release.rpm
...
# Install FFMPEG
cd ~
wget --no-check-certificate https://github.com/mysoft999/rTorrent/raw/main/ffmpeg-release-amd64-static.tar.xz
...
# Install unrar
cd ~
wget --no-check-certificate https://github.com/mysoft999/rTorrent/raw/main/rarlinux-x64-621.tar.gz
if [ $? -eq 0 ];then
...
# Install libtorrent
cd ~
wget https://github.com/mysoft999/rTorrent/raw/main/libtorrent-0.13.8.tar.gz
if [ $? -eq 0 ];then
...
# Install rTorrent
cd ~
wget https://github.com/mysoft999/rTorrent/raw/main/rtorrent-0.9.6.tar.gz
if [ $? -eq 0 ];then
...
# Download ruTorrent
cd /usr/share/nginx
wget --no-check-certificate https://github.com/Novik/ruTorrent/archive/v4.0.2.tar.gz
if [ $? -eq 0 ];then
...
# Install rTorrent
cd ~
wget https://github.com/mysoft999/rTorrent/raw/main/rtorrent-0.9.8.tar.gz
if [ $? -eq 0 ];then
    echo -e "${green} rTorrent下载成功 ${font}"
else 
    echo -e "${red} rTorrent下载失败 ${font}"
...
# 开始菜单设置
start_menu(){
	read -p "请输入数字(1或2)，1安装rTorrent0.9.6，2安装rTorrent0.9.8:" num
	case "$num" in
		1)
		install_0.9.6
		;;
